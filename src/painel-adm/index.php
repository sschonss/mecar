...
<head>
    ...
    <meta name="author" content="Wilson Junior de Oliveira Alvares">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-rec sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">MECAR</div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Motoristas</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Transporte</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <img class="mt-2" src="../img/LOGOTIPO_ÍCONE_3.png" width="100">
                    <div class="descricaoEmpresa">
                        <h7 class="ml-1" style="font-weight: bold;"><?php echo mb_strtoupper($nome_empresa)  ?></h7 class="ml-1"><br>
                        <h7 class="ml-1" style="font-weight: bold;"><?php echo mb_strtoupper($endereco_empresa)  ?></h7 class="ml-1">
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $user_usu ?>" type="text" class="form-control" id="user_usu" name="user_usu" placeholder="Nome de Usuário">
