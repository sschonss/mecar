...
<div class="row mt-4 mb-4">
    ...
    <a type="button" class="btn-info btn-sm ml-3 d-none d-md-block" href="index.php?pag=<?php echo $pag ?>&funcao=novo">Novo Usuário</a>
            ...
            <form id="form" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo @$user2 ?>" type="text" class="form-control" id="user" name="user" placeholder="Nome de Usuário">
