...
btn.addEventListener("click", function(){
  ...
  if (timeBusca > 172800) {
    ...
    alert("O periodo entre à Data e Hora inicial e Data e Hora Final deve ser de no Máximo 48 Horas, Verifique e Tente Novamente! ");
  ...
  $('#carregando').show();
    ...
    $.get( "../class/grafico.php", {
      "dataBase":dataBase, "dataIni":dataIni,
      "horaIni":horaIni,"dataFim":dataFim,
      "horaFim":horaFim, "linha01":linha01,
      "linha02":linha02,"linha03":linha03,
      "linha04":linha04}
      )
    ...
    .done(function(data) {
     ...
     var dataLinha1 = json.dataLinha1;
     var dataLinha2 = json.dataLinha2;
     var dataLinha3 = json.dataLinha3;
     var dataLinha4 = json.dataLinha4;
