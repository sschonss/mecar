 ...
 */
define ('PDF_HEADER_LOGO', '../img/logo.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'RELATÓRIOS AGROSUL');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "AGROSUL AGROAVICOLA INDUSTRIAL S.A\nEST CAMPESTRE SANTA TERESINHA, 1000 SÃO SEBASTIÃO DO CAÍ - RS");
