	...
	<div class="container">
		...
		<div class="table-responsive">
			...
			<table id="tabela" align="center" width="60%" cellspacing="0" border="1">
				...
				<thead>
              <tr>
                <th scope="row"colspan="1">DATA E HORA</th>
				...
				<tbody style="text-align-last: center;">
					...
					for ($i=0; $i < count($res); $i++) { 
					  ...
					  if ($res[$i]['vazao01'] != null || $res[$i]['vazao02'] != null) {
						...
						<tr>
							<td colspan="1" rowspan="1"><?php echo date('d/m/Y H:i', strtotime($res[$i]['dataHora'])) ?></td>
							<td colspan="1" rowspan="1"><?php echo $res[$i]['vazao01'] ?> m³</td>
							<td colspan="1" rowspan="1"><?php echo $res[$i]['vazao02'] ?> m³</td>
							<td colspan="1" rowspan="1"><?php echo $res[$i]['totalMoment'] ?> m³</td>
						</tr>
