...
<head>
    ...
    <title>Operações Sub-Produto</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="titulo" align="center"><b>Relatório Registro Operações Sub-Produto</b></p>
            ...
            <table id="tabela" width="100%" cellspacing="0" border="1">
                ...
                <thead>
                    ...
                    <tr style="font-weight: bold; background-color:#a9a9a9;">
                        <th scope="col" colspan="12" width=75%>REGISTRO DE OPERAÇÕES SUB-PRODUTO</th>
                    </tr>
                ...
                <tbody style="text-align-last: center;">
                    ...
                    ?>
                        ...
                        <tr>
                            <th colspan="1" rowspan="1"><?php echo $dataHora; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $usuario; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $comentario; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $acao; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $informacao; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $ip; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $nomeMaquina; ?></th>
                            <th colspan="1" rowspan="1"><?php echo $plataforma; ?></th>
